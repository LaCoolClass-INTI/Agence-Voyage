...
--Après la création des tableaux, on ajoute les différentes informations nécessaire. 
...
--Mise de 1 et 2 après Guadeloupe pour eviter des problemes de stations dans le meme lieu. 
...
--Insert test pour voir si on prend une station en dehors des zones données. Ne dois donc pas fonctionner dans la base de données SQL. 
